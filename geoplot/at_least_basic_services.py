...
proportion_safe_water = pd.read_csv("at_least_basic_access_to_water.csv")
...
joined.plot(ax=ax, column='Value', cmap='Greens', legend=True)
ax.set_title("Access to at least basic water services (% of Population)")
plt.show()